...
cmake ..\.. -G "Visual Studio 14 2015" -DCMAKE_INSTALL_PREFIX=dist -DCUSTOM_CMAKE=..\Custom-vs.cmake -DUSE_GETTEXT=0 -DSWIG_DIR=C:\msys64\mingw64\share\swig\3.0.6  -DUSE_CURL=0 -DBUILD_FLUID_OPCODES=0 -DBUILD_LUA_OPCODES=0 -DBUILD_LUA_INTERFACE=0 -DBUILD_CSOUND_AC_LUA_INTERFACE=0  -DHAVE_BIG_ENDIAN=0 -DCMAKE_16BIT_TYPE="unsigned short" -DLIBSNDFILE_LIBRARY="..\deps\lib\libsndfile-1.lib"  -DPTHREAD_LIBRARY="..\deps\lib\pthreadVC2.lib" -DCMAKE_SYSTEM_INCLUDE_PATH="..\deps\include" -DBUILD_PD_CLASS=0 -DUSE_DOUBLE=1 -DFLEX_EXECUTABLE="..\deps\win_flex_bison\win_flex.exe" -DBISON_EXECUTABLE="..\deps\win_flex_bison\win_bison.exe"
